"""Example of automatic vehicle control by DQN."""
...
# ==============================================================================
# -- Find CARLA module ---------------------------------------------------------
# set the absolute direction python egg
# ==============================================================================
try:
...
# add the package in carla folder
# ==============================================================================
try:
...
from test_control import DQNPolicy
...
class World(object):
    ...
    def restart(self, args):
        ...
        while self.player is None:
            ...
            w.location.z = 1.0
            self.player = self.world.try_spawn_actor(blueprint, w)
        # Set up the sensors.
...
class CameraManager(object):
    ...
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        # use the first sensor position
        self._camera_transforms = [

            (carla.Transform(
                carla.Location(x=2.5, y=0.0, z=2.0), carla.Rotation(pitch=-20.0, yaw=0.0, roll=0.0)), attachment.Rigid),
            (carla.Transform(
            ...
            # see the car
            # (carla.Transform(
            #     carla.Location(x=-5.5, z=5.0), carla.Rotation(pitch=-20.0)), attachment.Rigid),
            (carla.Transform(
...
def game_loop(args):
    ...
    try:
        ...
        # --- create a Carla server and spawn a vehicle --- #
        world = World(client.get_world(), hud, args)
        # --- load the policy model --- #
        model = torch.load('model/agent_DQN')
        agent = DQNPolicy(world.player, model)

        # --- running --- #
        clock = pygame.time.Clock()
        while True:
            # client sends 10 commands in one second
