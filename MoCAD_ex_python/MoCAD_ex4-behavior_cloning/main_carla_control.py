"""Example of automatic vehicle control by IRL."""
...
from control_policy import BehaviorCloning
...
def game_loop(args):
    ...
    try:
        ...
        model = torch.load('./train_model/model/model_bc')
        agent = BehaviorCloning(world.player, model, image_cut=[256, 128])

        # spawn_points = worldw.map.get_spawn_points()  # 7 spawn points
        # # --- vehicle start --- #
