...
class World(object):
    ...
    def restart(self, args):
        ...
        while self.player is None:
            ...
            # --- modify: fixed start --- #
            # first group: start 6-> end 1
            # second group: start 5-> end 2
...
class CameraManager(object):
    ...
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        self._parent = parent_actor
        self.hud = hud
        self.recording = True   # record the data and image
        ...
        self._camera_transforms = [
            ...
            # (carla.Transform(
            #     carla.Location(x=1.6, z=1.7), carla.Rotation(pitch=-10.0)), attachment.Rigid),
            (carla.Transform(
                carla.Location(x=1.6, y=-2.5, z=2.0), carla.Rotation(pitch=-20.0)), attachment.Rigid),
            (carla.Transform(
    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording:
            ...
            image.save_to_disk('IMG/%d' % self.image_name)
        ...
        with open('driving_log.csv', 'a') as csv_file:
            ...
            while True:
                ...
                if args.agent == "Roaming" or args.agent == "Basic":
                    ...
                    velocity = 3.6 * math.sqrt(vel.x**2 + vel.y**2 + vel.z**2)  # velocity
