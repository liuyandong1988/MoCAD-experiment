...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction=2.2):
        ...
        bound_y = 0.5 + self._parent.bounding_box.extent.y # sensor position
        Attachment = carla.AttachmentType  # attach type
        ...
        self._camera_transforms = [
            ...
            # cannot see the car
            (carla.Transform(
                carla.Location(x=1.6, z=3.0), carla.Rotation(pitch=-20.0)), Attachment.Rigid),
            # see the car
            # (carla.Transform(
